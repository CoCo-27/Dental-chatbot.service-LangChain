...
const Rightbar = () => {
  ...
  const handleTreat_2 = (value) => {
    setTreat_2(value);
  };

  const handleTreat_3 = (value) => {
    setTreat_3(value);
  };

  const handleTreat_4 = (value) => {};

  const handleTreat_5 = (value) => {
    setTreat_5(value);
  };

  const handleTreat_6 = (value) => {};
