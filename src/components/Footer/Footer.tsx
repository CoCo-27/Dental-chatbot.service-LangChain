...
const Footer = ({ menu }: Props) => {
  ...
  return (
    <footer className="relative bg-gradient-to-r from-teal-300 to-teal-100 text-navy-700 pt-8 pb-6">
      <div className="container mx-auto">
          ...
          <div className="flex w-full lg:w-8/12 justify-center px-4">
            <div className="flex flex-wrap items-top mb-6">
              <div className="pl-4 pr-8">
                <span className="block text-navy-600 text-lg font-semibold mb-4">
                  Legal And Policies
                </span>
                <ul className="list-unstyled">
                  <li>
                    <a
                      className="hover:text-white font-semibold block pb-2 text-base"
                      href="/terms"
                      target="_blank"
                    >
                      Terms of service
              ...
              <div className="pl-4 pr-8">
                ...
                <ul className="list-unstyled">
                  <li>
                    <a
                      className="flex gap-[2rem] hover:text-white font-semibold pb-2 text-base"
        ...
        <div className="flex items-center md:justify-between justify-center">
          <div className="flex lg:mb-0 mb-6">
            ...
            <div className="bg-white text-white shadow-lg font-normal h-10 w-10 flex items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2">
              <a
